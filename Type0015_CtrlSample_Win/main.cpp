...
int main()
{
	...
	// Search for a Module-file like "Type0015.md3".
#if defined( _WIN32 )
...
#endif
	if ( bRet == false ) {
		puts( "\"Type0015 Module\" is not found.\n" );
		return -1;
	}
...
#endif
	if ( bRet == false ) {
		puts( "Failed in loading \"Type0015 Module\".\n" );
		return -1;
	}
...
BOOL SetShootingMenu( LPRefObj pRefSrc ) 
{
	...
	do {
		...
		printf( " 4. Sensitivity                 5. WBTuneAuto            6. WBAutoType\n" );
		...
		printf( "16. PictureControlData         17. GetPicCtrlInfo       18. DeleteCustomPicCtrl\n" );
		printf( "19. PictureControlDataEx       20. MovieMeteringMode\n");
		printf( "21. MoviePictureControlData    22. MoviePictureControlDataEx\n");
		printf( "23. GetMoviePicCtrlInfo        24. DeleteMovieCustomPictureControl\n");
		printf( "25. MovieWBPresetData\n");
		printf( " 0. Exit\n>" );
		scanf( "%s", buf );
		wSel = atoi( buf );
		...
		switch( wSel )
		{
			...
			case 14:// WBPresetData
				bRet = SetWBPresetDataCapability( pRefSrc, kNkMAIDCapability_WBPresetData );
				break;
			case 15:// PictureControl
				bRet = SetEnumCapability( pRefSrc, kNkMAIDCapability_PictureControl );
				break;
			case 16:// PictureControlData
				bRet = PictureControlDataCapability( pRefSrc, kNkMAIDCapability_PictureControlData);
				break;
			case 17:// GetPicCtrlInfo 
				bRet = GetPictureControlInfoCapability( pRefSrc, kNkMAIDCapability_GetPicCtrlInfo );
				break;
			case 18:// DeleteCustomPictureControl
				bRet = DeleteCustomPictureControlCapability( pRefSrc, kNkMAIDCapability_DeleteCustomPictureControl );
				break;
			case 19:// PictureControlDataEx
				bRet = PictureControlDataCapability( pRefSrc, kNkMAIDCapability_PictureControlDataEx);
				break;
			case 20:// MovieMeteringMode
				bRet = SetUnsignedCapability( pRefSrc, kNkMAIDCapability_MovieMeteringMode );
				break;
			case 21:// MoviePictureControlData
				bRet = PictureControlDataCapability( pRefSrc, kNkMAIDCapability_MoviePictureControlData);
				break;
			case 22:// MoviePictureControlDataEx
				bRet = PictureControlDataCapability( pRefSrc, kNkMAIDCapability_MoviePictureControlDataEx);
				break;
			case 23:// GetMoviePicCtrlInfo
				bRet = GetPictureControlInfoCapability( pRefSrc, kNkMAIDCapability_GetMoviePicCtrlInfo );
				break;
			case 24:// DeleteMovieCustomPictureControl
				bRet = DeleteCustomPictureControlCapability( pRefSrc, kNkMAIDCapability_DeleteMovieCustomPictureControl );
				break;
			case 25:// MovieWBPresetData 
				bRet = SetWBPresetDataCapability( pRefSrc, kNkMAIDCapability_MovieWBPresetData );
				break;
			default:
				wSel = 0;
				break;
...
BOOL SetLiveView( LPRefObj pRefSrc ) 
{
	...
	do {
		...
		printf( "10. SpotWBChangeArea      11. SpotWBResultDispEnd	  12.Setmode\n");
		printf( " 0. Exit\n>" );
		scanf( "%s", buf );
		wSel = atoi( buf );
		...
		switch( wSel )
		{
			...
			case 11:// SpotWBResultDispEnd
				...
				break;
			case 12:// VideoMode
				bRet = SetEnumCapability(pRefSrc, kNkMAIDCapability_VideoMode);
				break;
			default:
				wSel = 0;
				break;
